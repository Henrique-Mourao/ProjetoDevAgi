//Henrique Mourão, Thierry, Raphael
package br.com.devsdoagi.JavaBasico.Hackathons.Carteira;
            ...
            while (true) {
                ...
                try {
                    ...
                    switch (opcao) {
                        ...
                        case "3" -> {
                            String cpf = lerEntrada(sc, "CPF do cliente: ");
                            System.out.println(si.listarInvestimentos(cpf));
                        }
                        case "4" -> System.out.println(si.relatorio());
                        case "0" -> {
